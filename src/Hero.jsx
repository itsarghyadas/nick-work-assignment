...
function Hero() {
  return (
    <div className="m-5 my-10 mt-24 lg:mt-10">
      <div className="hero-banner bg-indigo-50 py-3 px-3.5 rounded shadow-md border border-indigo-500/50">
        <div className="hero-banner-content space-y-2 md:space-y-0 sm:flex items-center justify-between">
          <p className="md:text-lg font-bold text-slate-800">
