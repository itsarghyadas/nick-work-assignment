...
export default function OptionMenu({ serviceOptions }) {
  const [selected, setSelected] = useState(serviceOptions[0]);

  return (
    <div className="font-medium">
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          <Listbox.Button className="relative w-full cursor-pointer rounded-lg bg-white border border-slate-500/20 py-2 px-3.5 text-left focus:outline-none focus:ring focus:ring-indigo-500/50 text-base">
